...
class KinesisSub():
    ...
    def kinesis_get_data(self):
        ...
        record_response = self.client.get_records(ShardIterator=shard_iter, Limit=10)
        while 'NextShardIterator' in record_response:
             record_response = self.client.get_records(ShardIterator=record_response['NextShardIterator'], Limit=10)
